  ...
  <div className="landing">
    <nav className="landing-nav">
      <div className="container landing-nav-inner">
        <div className="nav-brand"><a href="#"><img className="nav-brand-logo" src="/logo.png" alt="AI Interview Companion" /></a></div>
        <div className="nav-links">
          <a href="#features">Features</a>
          <a href="#how-it-works">How It Works</a>
          <a href="#pricing">Pricing</a>
          <Link to="/login">Sign In</Link>
          <Link to="/signup" id="nav-get-started" className="btn btn-primary btn-sm">Get Started Free</Link>
        </div>
      </div>
    </nav>
    ...
    <section id="pricing" className="section section-alt">
      <div className="container">
        <div className="section-header-centered">
          ...
          <p className="section-desc">We show you exactly where every rupee goes.</p>
        </div>
        <div className="landing-pricing-grid">
          <div className="landing-pricing-card glass-card">
            ...
            <ul className="landing-features">
              {['1 interview per day', '15 min duration', 'Basic AI feedback', 'Live transcript'].map(f => (
          ...
          <div className="landing-pricing-card landing-pricing-featured glass-card">
            ...
            <h3>Premium Interview</h3>
            <div className="landing-price">₹19 <span>/interview</span></div>
            <ul className="landing-features">
              {['50 minutes', 'GPT-4o AI interviewer', 'Full detailed feedback', 'PDF report', 'Learning roadmap'].map(f => (
                <li key={f}><CheckCircle size={13} /> {f}</li>
              ))}
            </ul>
            ...
            <div className="cost-mini">
              ...
              {[['Voice AI', 8], ['AI Analysis', 4], ['Storage', 3], ['Platform', 4]].map(([l, c]) => (
    ...
    <footer className="landing-footer">
      <div className="container footer-inner">
        <div className="footer-brand"><span>🎯</span> AI Interview Companion</div>
        <div className="footer-links">
          <Link to="/login">Login</Link><Link to="/signup">Sign Up</Link><a href="#pricing">Pricing</a>
        </div>
        <p className="footer-copy">© 2026 AI Interview Companion. Built for students, by developers.</p>
      </div>
    </footer>
  </div>
);
